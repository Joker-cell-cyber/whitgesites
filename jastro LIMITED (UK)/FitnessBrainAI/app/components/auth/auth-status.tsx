...
export default function AuthStatus({ className, isMobile = false }: AuthStatusProps) {
      ...
      {isAuthenticated ? (
        <>
          ...
          <div className="px-3 sm:px-4 py-1.5 sm:py-2 flex items-center gap-2">
            <span className="text-sm sm:text-base font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">
          ...
          <Link href="/coach" className="px-3 sm:px-4 py-1.5 sm:py-2 text-sm sm:text-base text-gray-300 hover:text-white transition-all duration-200 hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-blue-400 hover:to-purple-500 relative group cursor-pointer active:scale-95 text-center">
            Coach IA
