    ...
    <header className="fixed top-0 right-0 left-0 lg:left-64 z-40 h-16 bg-black/60 backdrop-blur-xl border-b border-purple-500/20">
      ...
      <div className="h-full px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <h1 className="text-xl font-bold text-white">
            ...
            {pathname.startsWith('/dashboard/chat') && 'Coach de séduction'}
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/dashboard/chat" className="hidden md:block">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {stars.map((star, index) => (
          <div 
            key={index}
            className="absolute rounded-full bg-gradient-to-r from-pink-400/30 to-purple-500/30 animate-float"
            style={{
              width: `${star.size}px`,
              height: `${star.size}px`,
              top: `${star.top}%`,
