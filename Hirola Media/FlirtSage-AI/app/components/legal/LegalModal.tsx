      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-xl bg-slate-900 border border-slate-700 p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="max-h-[70vh] overflow-y-auto pr-2 text-gray-300 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent">
                  {content.content.map((section, index) => (
                    <div key={index} className="mb-6">
                      <h4 className="text-lg font-semibold text-pink-400 mb-2">{section.title}</h4>
