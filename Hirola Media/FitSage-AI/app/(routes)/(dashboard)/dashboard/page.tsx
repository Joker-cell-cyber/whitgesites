  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4">
        <div className="p-4 bg-black/40 backdrop-blur-xl rounded-lg border border-gray-500/20">
      ...
      <div className="mt-6 bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-gray-500/20 space-y-3">
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-400">
                  <span className="text-purple-400">+300 tokens</span> sont ajoutés automatiquement à votre compte chaque mois.
                </p>
              </div>
      ...
      <div className="mt-6">
        ...
        <div className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-gray-500/20">
