  ...
  return (
    <section className="relative pt-32 pb-16 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-20 right-[10%] w-72 h-72 bg-poker-red-600/20 rounded-full filter blur-3xl animate-pulse-glow"></div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 items-center">
            <a 
              href="#pricing-tabs" 
              className="px-6 py-3 bg-gradient-to-r from-poker-red-700 to-poker-red-800 text-white rounded-lg font-medium button-glow"
            >
              View Packages
            </a>
          </div>
