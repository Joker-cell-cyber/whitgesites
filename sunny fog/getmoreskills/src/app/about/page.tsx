...
export const metadata: Metadata = {
  title: "About Us - GetMoreSkills",
  description: "Learn more about GetMoreSkills and our mission to help music producers develop their skills.",
};
    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center">
          About <span className="text-transparent bg-clip-text bg-gradient-to-r from-beat-purple-500 to-beat-gold-500">GetMoreSkills</span>
        </h1>
