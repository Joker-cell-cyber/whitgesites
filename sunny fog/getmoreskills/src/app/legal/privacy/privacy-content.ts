...
<p>Welcome to "${COMPANY.name}" website (referred to as the "Website" or "${COMPANY.website}")</p>
...
<h2>Music Content Information</h2>

<p>When you submit music projects and materials to ${COMPANY.serviceName} for coaching services, we collect and process this content to provide our services. This includes project files, audio samples, music arrangements, and any other materials you provide for the purpose of music production coaching.</p>

<h3>Data Retention for Music Content</h3>
<p>For your music content and project files:</p>
<ul>
  <li>Music projects and materials: Retained for 30 days after coaching session</li>
  <li>Session recordings: Retained for 60 days after delivery</li>
  <li>Coaching notes and feedback: Retained for 90 days after session completion</li>
</ul>

<h2>No Information Collected from Children</h2>

<p>${COMPANY.serviceName} will never knowingly collect any Personal Information about children under the age of 16. If ${COMPANY.serviceName} obtains actual knowledge that it has collected Personal Information about a child under the age of 16, that information will be immediately deleted from its database. Because it does not collect such information, ${COMPANY.serviceName} has no such information to use or to disclose to third parties.</p>
