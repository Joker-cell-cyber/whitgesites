...
export default function ContactForm() {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-vid-red-500 to-vid-orange-500 mb-6">Send Us a Message</h2>
        ...
        <div>
          <button
            ...
            className={`w-full px-6 py-3 text-white font-medium rounded-md shadow-sm ${
              isSubmitting ? "bg-vid-red-800" : "bg-gradient-to-r from-vid-red-600 to-vid-orange-500 hover:from-vid-red-700 hover:to-vid-orange-600 button-glow"
            } focus:outline-none focus:ring-2 focus:ring-vid-red-500 focus:ring-offset-2 transition-colors duration-200`}
          >
