        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden aspect-square md:aspect-video shadow-xl">
              <div className="absolute inset-0 bg-gradient-to-br from-nutrition-green-600/30 to-carrot-500/30 mix-blend-overlay z-10"></div>
              <div className="bg-gradient-to-br from-nutrition-green-100 to-carrot-100 h-full w-full flex items-center justify-center">
                <svg className="h-1/3 w-1/3 text-nutrition-green-600 opacity-20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-nutrition-green-600 to-carrot-500">
              Our Mission
            </h2>
            <p className="text-gray-600 text-lg mb-6">
              At PrepYourMeal, our mission is to revolutionize the way people approach nutrition by providing accessible, delicious, and scientifically-backed meal plans that fit seamlessly into modern lifestyles.
            </p>
            <p className="text-gray-600 text-lg mb-6">
