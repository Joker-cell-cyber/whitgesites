    ...
    <div className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16">
          ...
          >
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-nutrition-green-600 to-carrot-500">
              Our Process
            </span>
          </motion.h2>
          <motion.p
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="flex-shrink-0">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-nutrition-green-500 to-carrot-500 flex items-center justify-center text-white font-bold text-xl">
                  {step.number}
                </div>
              </div>
              <div>
