  ...
  return (
    <div className="border-b border-gray-200">
      ...
      >
        ...
        <ChevronDownIcon
          className={`h-5 w-5 text-nutrition-green-500 transition-transform duration-300 ${
  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gray-50">
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-nutrition-green-100 to-transparent"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <a
            href="mailto:support@prepyourmeal.com"
