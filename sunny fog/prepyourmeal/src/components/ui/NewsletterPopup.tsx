    ...
    <AnimatePresence>
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/50 p-4">
          ...
          >
            <div className="bg-gradient-to-r from-nutrition-green-600 to-carrot-500 p-1">
              <button
                onClick={handleClose}
            ...
            <div className="p-6 md:p-8">
              <h3 className="text-2xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-nutrition-green-600 to-carrot-500">
              ...
              {submitted ? (
                <div className="bg-nutrition-green-50 text-nutrition-green-700 p-4 rounded-lg border border-nutrition-green-200 text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-nutrition-green-500 focus:border-nutrition-green-500"
                    />
                  </div>
                  
                  <button
                    type="submit"
                    className="w-full py-3 px-4 bg-gradient-to-r from-nutrition-green-600 to-carrot-500 text-white rounded-lg transition-colors hover:from-nutrition-green-700 hover:to-carrot-600 font-medium"
                  >
                    Subscribe Now
                  </button>
