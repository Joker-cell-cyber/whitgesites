      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800">
              Meal Prep <span className="gradient-text">Benefits</span>
            </h2>
        ...
        >
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-nutrition-green-600/10 to-carrot-500/10 rounded-full transform translate-x-10 -translate-y-10 blur-2xl"></div>
              
              <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-nutrition-green-600 to-carrot-500 flex items-center justify-center text-white mb-5">
                {benefit.icon}
              </div>
        ...
        >
          <a href="#pricing" className="inline-flex items-center text-nutrition-green-600 hover:text-nutrition-green-700 transition-colors font-medium">
            <span>View our meal plan packages</span>
