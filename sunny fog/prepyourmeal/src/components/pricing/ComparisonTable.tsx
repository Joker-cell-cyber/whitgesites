...
export default function ComparisonTable() {
  ...
  const prices = {
    short: { basic: "€9.90", standard: "€19.90", advanced: "€29.90", pro: "€39.90", ultimate: "€49.90" },
    long: { starter: "€59.90", essential: "€69.90", plus: "€79.90", premium: "€99.90", enterprise: "€109.90", master: "€129.90" },
    advertising: { light: "€29.90", business: "€49.90", growth: "€59.90", professional: "€89.90", elite: "€119.90" }
  };
            ...
            <thead className="bg-gray-800/50">
              <tr>
                ...
                {selectedCategory === 'short' && (
                  <>
                    ...
                    <th className="py-4 px-4 text-center">
                      ...
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].advanced}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Pro</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].pro}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Ultimate</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].ultimate}</div>
                    </th>
                  </>
                )}
                {selectedCategory === 'long' && (
                  <>
                    <th className="py-4 px-4 text-center">
                      ...
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].starter}</div>
                    </th>
                    <th className="py-4 px-4 text-center bg-gradient-to-b from-vid-red-900/20 to-transparent relative">
                      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-vid-red-600 to-vid-orange-500"></div>
                      <div className="text-white font-bold">Essential</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].essential}</div>
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-vid-red-600 to-vid-orange-500 text-white text-xs uppercase font-bold py-1 px-2 rounded">
                        Popular
                      </div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      ...
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].plus}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                    ...
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Master</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].master}</div>
                    </th>
                  </>
                )}
                {selectedCategory === 'advertising' && (
                  <>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Light</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].light}</div>
                    </th>
                    <th className="py-4 px-4 text-center bg-gradient-to-b from-vid-red-900/20 to-transparent relative">
                      <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-vid-red-600 to-vid-orange-500"></div>
                      <div className="text-white font-bold">Business</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].business}</div>
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-vid-red-600 to-vid-orange-500 text-white text-xs uppercase font-bold py-1 px-2 rounded">
                        Popular
                      </div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      ...
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].growth}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                    ...
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Elite</div>
                      <div className="text-vid-red-400 text-xl font-bold">{prices[selectedCategory].elite}</div>
                    </th>
                  </>
                )}
              </tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="py-6 px-4 text-center">
                  ...
                  >
                    {selectedCategory === 'short' ? 'Select Basic' : 
                     selectedCategory === 'long' ? 'Select Starter' : 
                     'Select Light'}
                  </a>
                </td>
                <td className="py-6 px-4 text-center bg-gradient-to-b from-vid-red-900/10 to-transparent">
                  ...
                  >
                    {selectedCategory === 'short' ? 'Select Standard' : 
                     selectedCategory === 'long' ? 'Select Essential' : 
                     'Select Business'}
                  </a>
                </td>
                <td className="py-6 px-4 text-center">
                  <a 
                    ...
                    className="inline-block px-4 py-2 bg-gray-800 hover:bg-gray-700 transition-colors text-white rounded-lg text-sm font-medium"
                  >
                    {selectedCategory === 'short' ? 'Select Advanced' : 
                     selectedCategory === 'long' ? 'Select Plus' : 
                     'Select Growth'}
                  </a>
                </td>
                <td className="py-6 px-4 text-center">
                  <a 
                    ...
                    className="inline-block px-4 py-2 bg-gray-800 hover:bg-gray-700 transition-colors text-white rounded-lg text-sm font-medium"
                  >
                    {selectedCategory === 'short' ? 'Select Pro' : 
                ...
                <td className="py-6 px-4 text-center">
                  <a 
                    ...
                    className="inline-block px-4 py-2 bg-gray-800 hover:bg-gray-700 transition-colors text-white rounded-lg text-sm font-medium"
                  >
                    {selectedCategory === 'short' ? 'Select Ultimate' : 
                     selectedCategory === 'long' ? 'Select Master' : 
                     'Select Elite'}
                  </a>
                </td>
              </tr>
