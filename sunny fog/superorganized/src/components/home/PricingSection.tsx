  ...
  return (
    <section className="py-20 relative overflow-hidden bg-white" id="pricing">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-full h-64 bg-notion-accent-50 opacity-30"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-notion-accent-100 opacity-30 rounded-full transform translate-x-1/4 translate-y-1/4"></div>
      </div>
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black">
              Simple <span className="hand-drawn-accent">Pricing</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`card-hand-drawn overflow-hidden relative bg-white ${
                plan.popular ? 'border-notion-accent-500' : ''
              }`}
            >
              {plan.popular && (
