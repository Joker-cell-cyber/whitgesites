        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              At {COMPANY.name}, we envision a world where businesses can harness the full potential of their data and technology investments. Our vision is to be the catalyst that transforms organizations through strategic consulting that bridges the gap between business challenges and technological solutions.
            </p>
          </section>
