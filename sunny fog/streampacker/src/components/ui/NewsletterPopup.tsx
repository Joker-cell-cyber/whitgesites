      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-70 backdrop-blur-sm">
          <motion.div
            ...
            className="relative bg-gradient-to-br from-[#0f0f1a] to-[#1a1a24] rounded-xl max-w-md w-full p-8 shadow-2xl border border-[--neon-purple]/20"
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    } rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[--neon-purple]`}
                    value={email}
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full py-3 px-4 bg-gradient-to-r from-[--neon-purple] to-[--neon-blue] hover:opacity-90 text-white rounded-lg font-medium transition-all duration-200 flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
