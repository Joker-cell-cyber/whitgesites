        ...
        <div className="absolute inset-0 bg-[#1a1a1a] overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className="relative inline-block">
              {/* The ping animation */}
              <div className="h-5 w-5 bg-vid-blue-500 rounded-full animate-ping absolute"></div>
              <div className="h-5 w-5 bg-vid-blue-500 rounded-full relative"></div>
            </div>
          </div>
        </div>
        
        <div className="absolute left-4 bottom-4 bg-gray-900 p-4 rounded-lg shadow-lg border border-gray-800 max-w-xs">
          <h3 className="font-bold text-white">ContentScript Headquarters</h3>
          ...
          <a 
            ...
            className="inline-flex items-center mt-3 text-sm text-vid-blue-400 hover:text-vid-blue-300"
          >
