...
export default function ContactForm() {
  ...
  return (
    <motion.div
      ...
      className="bg-[#181c30] border border-gray-800/30 rounded-lg shadow-xl p-8"
    >
      <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-script-blue-500 to-script-purple-500 mb-6">Send Us a Message</h2>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 bg-gray-900 border border-gray-700 text-white rounded-md focus:ring-2 focus:ring-script-blue-500 focus:border-script-blue-500"
        ...
        <div>
          <button
            ...
            className={`w-full px-6 py-3 text-white font-medium rounded-md shadow-sm ${
              isSubmitting ? "bg-script-blue-800" : "bg-gradient-to-r from-script-blue-600 to-script-purple-500 hover:from-script-blue-700 hover:to-script-purple-600 button-glow"
            } focus:outline-none focus:ring-2 focus:ring-script-blue-500 focus:ring-offset-2 transition-colors duration-200`}
          >
