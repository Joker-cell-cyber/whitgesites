          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                Email: <a href={`mailto:${COMPANY.email}`} className="hover:text-[#00B2A9] transition-colors">{COMPANY.email}</a>
              </li>
              <li className="text-gray-400">
                Phone: <a href={`tel:${COMPANY.phone}`} className="hover:text-[#00B2A9] transition-colors">{COMPANY.phone}</a>
              </li>
            </ul>
          </div>
        </div>
