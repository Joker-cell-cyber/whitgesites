            ...
            {faqs.map((faq, index) => (
              <div key={index}>
                <button
                  ...
                  className="w-full text-left flex justify-between items-center p-4 rounded-lg bg-gradient-to-r from-gray-800/60 to-gray-700/60 backdrop-blur-sm border border-gray-700/30 transition-colors hover:from-gray-800/80 hover:to-gray-700/80"
                >
                ...
                {openIndex === index && (
                  <div className="mt-3 px-4 py-3 text-gray-300 text-sm leading-relaxed bg-gradient-to-b from-gray-900/60 to-gray-900/40 backdrop-blur-sm rounded-lg">
                    {faq.answer}
                  </div>
                )}
              </div>
