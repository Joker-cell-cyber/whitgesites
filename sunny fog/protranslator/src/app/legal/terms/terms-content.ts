...
<h3>${COMPANY.serviceName} Translation Packages Offered:</h3>
...
<ul>
  <li>Basic: $19.50</li>
  <li>Standard: $39.99</li>
  <li>Advanced: $59.50</li>
  <li>Professional: $79.90</li>
  <li>Premium: $109.90</li>
  <li>Enterprise: $119.50</li>
</ul>

<p>You will receive a confirmation email with details about your translation services and next steps within 24 hours of placing your order.</p>
...
<p><strong>Payment Structure:</strong> All purchases on ${COMPANY.serviceName} are processed as <strong>one-time payments</strong>. We do not offer recurring subscriptions for any of our translation plans.</p>
...
<p>Refunds may be requested within thirty (30) days of the date you received the translation services.</p>
<p>Due to the custom nature of our translation services, refunds are handled on a case-by-case basis. If you are not satisfied with your translation, we first encourage you to request revisions. If after revisions you are still not satisfied, please contact our customer service team.</p>

<p>In order to request a refund, contact customer service by phone or email within 30 days of receipt of your translation. Your refund, if approved, will be credited back to your original payment method, and may take up to 3-5 business days to process, depending on your payment provider.</p>
