...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0f172a] border-t border-blue-900/20 relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-blue-600/5 blur-3xl"></div>
        <div className="absolute top-20 right-20 w-60 h-60 rounded-full bg-indigo-500/5 blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 relative z-10">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              <div className="rounded-full bg-white/10 w-10 h-10 flex items-center justify-center">
                <span className="text-xl font-bold text-gradient-blue">P</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                <EnvelopeIcon />
                <a href={`mailto:${COMPANY.email}`} className="text-gray-400 hover:text-blue-400 transition-colors">
                  {COMPANY.email}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <PhoneIcon />
                <a href={`tel:${COMPANY.phone}`} className="text-gray-400 hover:text-blue-400 transition-colors">
                  {COMPANY.phone}
                </a>
              </li>
            </ul>
        ...
        <hr className="border-blue-900/20 my-8" />
