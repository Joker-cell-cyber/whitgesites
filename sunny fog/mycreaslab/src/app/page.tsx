  ...
  return (
    <div className="overflow-hidden">
      ...
      <Suspense fallback={<div className="min-h-screen flex items-center justify-center">
        <div className="animate-pulse w-16 h-16 rounded-full bg-gradient-to-r from-teal-500 to-yellow-400"></div>
      </div>}>
        <ParallaxHero />
      </Suspense>
      ...
      {/* Call to Action */}
      <Suspense fallback={<div className="h-64 animate-pulse bg-gray-100 dark:bg-gray-900"></div>}>
        <CtaSection />
      </Suspense>
    </div>
  );
