            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-turquoise-500 focus:border-turquoise-500 text-gray-900"
              ...
              <div>
                <button
                  ...
                  className={`w-full bg-turquoise-600 hover:bg-turquoise-700 text-white font-medium py-3 px-6 rounded-lg transition-colors ${isSubmitting ? 'bg-gray-400' : ''}`}
                >
                  {isSubmitting ? (
...
function ContactInfoCard({ icon, title, description, info, link }: { icon: React.ReactNode; title: string; description: string; info: string; link: string }) {
  return (
    <div className="bg-white p-8 rounded-xl shadow-sm text-center">
      ...
      <a href={link} className="text-turquoise-600 hover:text-turquoise-700 font-medium transition-colors">
        {info}
      </a>
    </div>
  );
