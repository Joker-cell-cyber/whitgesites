...
export default function ContactHero() {
  return (
    <section className="relative overflow-hidden bg-gray-900 py-20 md:py-24">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-gray-900 via-indigo-900/60 to-gray-900"></div>

      {/* Background image */}
      <div className="absolute inset-0 opacity-20">
        <Image
          src="/images/contact-hero-bg.jpg"
          alt="Landing page design studio"
          fill
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            Have a question about our landing page services? Ready to start a project?
            Our team is here to help you create high-converting landing pages.
          </motion.p>
