...
export default function ContactInfo() {
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-8 text-transparent bg-clip-text bg-indigo-500">Contact Information</h2>
      ...
      <div className="mt-12">
        <h3 className="text-lg font-medium text-indigo-400 mb-4">Business Hours</h3>
