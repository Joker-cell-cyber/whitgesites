        ...
        <section className="relative py-20 lg:py-32 bg-gradient-to-b from-black to-zinc-950 overflow-hidden">
          ...
          <Container className="relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                YourSuperDev was born from a vision to revolutionize the way businesses approach web development, delivering innovative digital solutions that drive real-world results.
              </motion.p>
            </div>
          </Container>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="relative rounded-2xl overflow-hidden">
                  <Image
                    src="https://source.unsplash.com/featured/600x400?business,technology"
                    alt="Notre mission"
                    width={600}
                    height={400}
              ...
              >
                ...
                <p className="text-zinc-400 mb-6">
                  At YourSuperDev, we believe that digital transformation is the key to business success in today's fast-paced world. Our mission is to design innovative technological solutions that empower businesses to stand out in an increasingly competitive landscape.
                </p>
          ...
          <Container>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="relative rounded-2xl overflow-hidden">
                  <Image
                    src="https://source.unsplash.com/featured/600x400?team,coding"
                    alt="Why choose us"
                    width={600}
                    height={400}
                    className="w-full h-auto"
