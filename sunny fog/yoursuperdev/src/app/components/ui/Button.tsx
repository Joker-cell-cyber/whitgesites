...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white shadow-lg hover:shadow-xl hover:shadow-purple-500/20",
      secondary:
      ...
      ghost:
        "bg-transparent text-purple-600 hover:bg-purple-600/10",
    };
