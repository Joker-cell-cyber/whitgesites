  ...
  return (
    ...
    >
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="relative text-foreground hover:text-purple-500 transition-colors duration-200"
              >
            ...
            <MagneticButton size="sm">Start a project</MagneticButton>
          </nav>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            className="fixed inset-0 bg-gradient-to-br from-purple-900/90 to-black/95 backdrop-blur-md z-40 flex items-center justify-center"
            ...
            >
              {navLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-2xl font-medium text-white hover:text-purple-300 transition-colors"
