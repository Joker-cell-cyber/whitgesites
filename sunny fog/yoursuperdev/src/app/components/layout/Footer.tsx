      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <div className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-500">
              {COMPANY.name}
            </div>
            <div className="text-sm text-zinc-500">
              <p>{COMPANY.address}</p>
              <p className="mt-2">
                <a href={`mailto:${COMPANY.email}`} className="hover:text-purple-400 transition-colors">
                  {COMPANY.email}
                </a>
              </p>
              <p className="mt-2">
                <a href={`tel:${COMPANY.phone}`} className="hover:text-purple-400 transition-colors">
                  {COMPANY.phone}
                </a>
              </p>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link 
                  href="/about"
                  className="text-sm text-zinc-400 hover:text-purple-400 transition-colors cursor-pointer text-left"
                >
                  About Us
                </Link>
              </li>
          ...
          <div>
            ...
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg transition-all duration-300 text-sm font-medium"
            >
        ...
        <div className="border-t border-zinc-800 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <Image 
            src="/images/about/corp logo whitye.png"
