  ...
  useEffect(() => {
    ...
    if (packageId && categoryParam) {
      ...
      if (mockPackages[category] && mockPackages[category][id]) {
        ...
        // If package not found, log for debugging
        console.log(`Package not found for category: ${category}, id: ${id}`);
        console.log('Available packages:', Object.keys(mockPackages[category] || {}));
