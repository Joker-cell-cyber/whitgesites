      ...
      >
        ...
        <div className="absolute inset-0 bg-[#1F2937] overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <div className="h-5 w-5 bg-lead-blue-500 rounded-full animate-ping absolute"></div>
            <div className="h-5 w-5 bg-lead-blue-500 rounded-full relative"></div>
          </div>
        </div>
        
        <div className="absolute left-4 bottom-4 bg-gray-900 p-4 rounded-lg shadow-lg border border-gray-800 max-w-xs">
          <h3 className="font-bold text-white">iGotYourLead Headquarters</h3>
          <p className="text-gray-300 text-sm mt-1">
            3063 S Sailors Way<br />
            GILBERT, AZ 85295<br />
            United States
          </p>
          <a 
            href="https://maps.google.com/?q=3063+S+Sailors+Way+GILBERT+AZ+85295" 
            target="_blank"
            rel="noopener noreferrer" 
            className="inline-flex items-center mt-3 text-sm text-lead-blue-400 hover:text-lead-blue-300"
          >
