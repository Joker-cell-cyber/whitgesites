        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link href="/" className="flex items-center">
              <span className="text-xl font-bold bg-gradient-to-r from-make-purple-500 to-make-blue-500 bg-clip-text text-transparent">
                {COMPANY.serviceName}
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-600 hover:text-make-purple-500 transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-gray-600 hover:text-make-purple-500 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-600 hover:text-make-purple-500 transition-colors">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-600 hover:text-make-purple-500 transition-colors">
                  About Us
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li>
                <button 
                  ...
                  className="text-gray-600 hover:text-make-purple-500 transition-colors cursor-pointer"
                >
                  Privacy Policy
                </button>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600">
                Email: <a href={`mailto:${COMPANY.email}`} className="hover:text-make-purple-500 transition-colors">{COMPANY.email}</a>
              </li>
              <li className="text-gray-600">
                Phone: <a href={`tel:${COMPANY.phone}`} className="hover:text-make-purple-500 transition-colors">{COMPANY.phone}</a>
              </li>
            </ul>
          </div>
        </div>
