      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="mb-4 md:mb-0 text-sm md:text-base flex-1 pr-4">
          <p>
            ...
            <button 
              ...
              className="text-make-purple-300 hover:text-make-purple-200 underline"
            >
              Cookie Policy
            </button>.
          </p>
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className="bg-make-purple-600 text-white px-5 py-2 rounded-lg font-medium hover:bg-make-purple-700 transition-colors"
          >
            Accept
          </button>
        </div>
