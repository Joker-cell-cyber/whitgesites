        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">
              Professional elo boosting services for League of Legends, Valorant, and other competitive games
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                Email: <a href={`mailto:${COMPANY.email}`} className="hover:text-blue-400 transition-colors">{COMPANY.email}</a>
              </li>
              <li className="text-gray-400">
                Phone: <a href={`tel:${COMPANY.phone}`} className="hover:text-blue-400 transition-colors">{COMPANY.phone}</a>
              </li>
            </ul>
          </div>
        </div>
