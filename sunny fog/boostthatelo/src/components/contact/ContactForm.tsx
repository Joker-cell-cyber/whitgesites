  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 mb-6">Send Us a Message</h2>
        ...
        {showThankYou && (
          <div className="bg-green-900 bg-opacity-30 border border-green-500 p-6 rounded-lg mb-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-[#1e1e1e] border border-[#333] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
        ...
        <div className="mb-6">
          ...
          <input
            ...
            onChange={handleChange}
            required
            className="w-full px-4 py-2 bg-gray-900 border border-gray-700 text-white rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            name="message"
            rows={6}
            className="w-full bg-gray-800/40 border border-gray-700/60 rounded-md shadow-inner p-3 text-gray-300 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div className="text-right">
          <button
            ...
            className="inline-flex items-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSubmitting ? (
              <>
