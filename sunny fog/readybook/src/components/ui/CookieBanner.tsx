...
export default function CookieBanner() {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed bottom-0 left-0 right-0 z-50 bg-book-blue-900 border-t border-book-blue-800 shadow-lg"
            ...
            <div className="container mx-auto px-4 py-4 md:py-5 flex flex-col md:flex-row items-center md:items-start md:justify-between">
              ...
              <div className="flex flex-wrap gap-2 mt-2 md:mt-0">
                <button
                  ...
                  className="px-4 py-2 bg-book-blue-800 hover:bg-book-blue-700 text-white rounded-lg text-sm transition-colors"
                >
                  Reject All
                </button>
                <button
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-book-blue-600 to-book-green-600 hover:from-book-blue-700 hover:to-book-green-700 text-white rounded-lg text-sm font-medium transition-colors"
                >
                  Accept All
                </button>
              </div>
                ...
                <div className="flex items-start justify-between p-4 bg-book-blue-800/50 rounded-lg">
                  <div>
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 px-2 py-0.5 bg-book-blue-700 text-white text-xs rounded">Required</span>
                    </div>
