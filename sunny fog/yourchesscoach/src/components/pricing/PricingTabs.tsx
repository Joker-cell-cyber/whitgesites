  ...
  const pricingCategories = {
    ...
    long: [
      ...
      },
      {
        ...
        delivery: "8 days",
        idealFor: "Top-tier content creators, production companies, corporate training"
      },
      {
        name: "Ultimate Long",
        price: 119.50,
        ...
        complexity: "Professional+",
        description: "The ultimate package for high-end, complex projects",
        features: [
          "Advanced visual effects & compositing",
          "Master-level color grading",
          "Professional sound mixing & mastering",
          "5 revision rounds",
          "Advanced motion graphics",
        ...
        delivery: "10 days",
        idealFor: "Film producers, high-end clients, professional productions"
      }
    ],
    advertising: [
      {
        ...
        duration: "Up to 30 sec",
        complexity: "Standard",
        description: "Simple professional ad for social media and digital platforms",
        features: [
        ...
        delivery: "5 days",
        idealFor: "Small businesses, startups, social media campaigns"
      },
      {
        name: "Standard Ad",
        price: 109.90,
        duration: "Up to 45 sec",
        complexity: "Advanced",
        description: "Professional ad with advanced features for better audience engagement",
        features: [
          "Professional editing",
          "Custom motion graphics",
          "Professional color grading",
        ...
        delivery: "7 days",
        popular: true,
        idealFor: "Mid-sized businesses, marketing campaigns, product launches"
      },
      {
        name: "Premium Ad",
        price: 119.50,
        duration: "Up to 60 sec",
        complexity: "Professional",
        description: "High-end commercial with all premium features",
        features: [
        ...
        delivery: "10 days",
        idealFor: "Large businesses, agencies, professional marketing campaigns"
      }
    ]
  };
