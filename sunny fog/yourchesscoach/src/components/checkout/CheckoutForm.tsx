      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-6">
          ...
          <div>
            ...
            {/* Billing Terms - One-time payment notice */}
            <div className="mt-4 p-3 bg-[#0c1d3d] rounded-lg border border-green-700 text-sm">
              <p className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-green-500" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-green-400 font-medium">This is a one-time payment</span>
              </p>
              <p className="ml-7 text-gray-300 mt-1">Your card will be charged only once. This is not a subscription - no recurring payments will be processed.</p>
            </div>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <label htmlFor="consent" className={`text-sm ${errors.consent ? 'text-red-500' : 'text-gray-300'}`}>
                  I consent to be charged for this one-time purchase and accept the{" "}
