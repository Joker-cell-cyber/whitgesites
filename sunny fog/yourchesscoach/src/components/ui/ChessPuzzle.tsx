...
const puzzles: PuzzleType[] = [
  {
    ...
    solution: [[3, 6], [3, 0]],
    message: 'Checkmate in one move! Move the queen to deliver checkmate.'
  },
  {
    id: 'puzzle-2',
    ...
    solution: [[0, 6], [0, 7]],
    message: 'Checkmate in one move! Use the rook to deliver checkmate.'
  },
  {
    id: 'puzzle-3',
    difficulty: 'advanced',
    ...
    solution: [[5, 5], [7, 6]],
    message: 'Find the winning move with the knight!'
  }
];
