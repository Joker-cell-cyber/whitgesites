          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="inline-block">
                <a 
                  href="/contact" 
                  className="px-8 py-4 bg-gradient-to-r from-cs-blue-600 to-cs-navy-600 text-white rounded-xl font-semibold button-glow transition-transform hover:-translate-y-1"
                >
                  Get in Touch
                </a>
              </div>
