        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute -bottom-20 w-full">
            <svg width="100%" height="320" viewBox="0 0 1440 320" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-10">
              <path d="M0 160L60 186.7C120 213 240 267 360 272C480 277 600 235 720 213.3C840 192 960 192 1080 213.3C1200 235 1320 277 1380 298.7L1440 320V0H1380C1320 0 1200 0 1080 0C960 0 840 0 720 0C600 0 480 0 360 0C240 0 120 0 60 0H0V160Z" fill="#3A6FFF"/>
            </svg>
          </div>
          <div className="absolute left-1/4 top-1/4 w-64 h-64 bg-cs-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70"></div>
          <div className="absolute right-1/4 bottom-1/4 w-64 h-64 bg-cs-navy-100 rounded-full mix-blend-multiply filter blur-3xl opacity-70"></div>
      </div>
            ...
            <motion.div
              ...
              >
                ...
                <div className={`p-6 bg-white h-full flex flex-col relative z-10 ${
                  plan.popular ? 'border-2 border-cs-blue-500' : 'border border-cs-blue-200'
                }`}>
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-cs-blue-500 to-cs-navy-500 text-white text-xs font-bold px-4 py-1 rounded-full">
                      MOST POPULAR
                    </div>
                  )}
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    {plan.popular && (
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-cs-blue-500">
                        <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="currentColor" />
                      </svg>
                    )}
                  </div>
                  
                  <div className="my-4 pb-4 border-b border-cs-blue-100">
                  ...
                  <div className="space-y-3 mb-6 flex-grow">
                    {plan.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start">
                        <svg className="w-5 h-5 text-cs-blue-500 mt-0.5 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <a 
                    ...
                    className={`block text-center w-full py-3 rounded-lg font-medium relative overflow-hidden group ${
                      plan.popular 
                        ? 'bg-gradient-to-r from-cs-blue-600 to-cs-navy-600 text-white hover:shadow-lg transition-shadow' 
                        : 'bg-cs-blue-50 text-cs-blue-700 hover:bg-cs-blue-100 transition-colors'
                    }`}
                  >
