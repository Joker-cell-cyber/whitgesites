...
export default function PricingFAQ() {
  ...
  const faqs = [
    ...
    {
      question: "Can I see samples of your work before purchasing?",
      answer: "Contact our sales team at support@callscriptx.com to request script samples relevant to your industry. While we can't share client-specific scripts due to confidentiality, we have generic samples that demonstrate our writing style and expertise."
    }
  ];
