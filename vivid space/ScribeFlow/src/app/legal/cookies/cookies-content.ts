...
<h3>Introduction</h3>
<p>${COMPANY.serviceName} ("we", "our", or "us") uses cookies and similar technologies on our website ${COMPANY.website} (the "Website"). This Cookie Policy explains what cookies are, how we use them, your choices regarding cookies, and further information about cookies.</p>
