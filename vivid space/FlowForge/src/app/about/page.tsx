    ...
    <div className="bg-gradient-to-b from-white to-gray-50 py-24">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-make-purple-600 to-make-blue-600 rounded-2xl shadow-lg p-10 text-black">
            ...
            <div className="mt-12 text-center">
              ...
              <p className="mb-6 text-black/90">Let's discuss how we can help you automate your workflows and boost productivity.</p>
              <a 
                href="/pricing" 
