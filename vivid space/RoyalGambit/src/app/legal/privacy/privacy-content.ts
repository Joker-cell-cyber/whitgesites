...
<p>This Privacy Policy governs your use of this Website and any content, products or services made available from or through this website including any sub domains thereof ("Website"). The Website is made available by ${COMPANY.serviceName}.</p>

<p>Address: ${COMPANY.address} (Hereinafter referred to as "Company").</p>
...
<p>This Website is intended for users who are located in the United States of America and the European Union. The Privacy Policy shall be interpreted under the laws of the United States of America.</p>
...
<p><strong>(c) IP Addresses.</strong> Company automatically tracks certain information based upon your behavior on the site. We may use this information to do internal research on our users' demographics, interests, and behavior to better understand, protect and serve you and our community. This information may include the URL that you just came from (whether this URL is on the site or not), which URL you next go to (whether this URL is on the site or not), your computer browser information, and your IP address.</p>

<h5>1.5. No Information Collected from Children</h5>
<p>Company will never knowingly collect any Personal Information about children under the age of 16. If Company obtains actual knowledge that it has collected Personal Information about a child under the age of 16, that information will be immediately deleted from its database. Because it does not collect such information, Company has no such information to use or to disclose to third parties.</p>

<h5>1.6. Credit Card Information and Payment Processing</h5>
<p>Company may, in certain instances, collect credit card numbers and related information when an individual places an order for coaching services on Company's Website. When the credit card information is submitted to Company, such information is encrypted and is protected with SSL encryption software. Company will use the credit card information for purposes of processing and completing the transaction you requested on the Website, and the credit card information will be disclosed to third parties as necessary to complete the requested purchase transaction.</p>

<h4>2.0. Use of Personal Information</h4>

<h5>2.1. Chess Coaching Services</h5>
<p>Company uses the chess materials and information you provide to deliver the coaching services you requested. This content is retained according to our data retention policies outlined below.</p>

<h5>2.2. Data Retention for Chess Content</h5>
<p>For your chess content and coaching files:</p>
<ul>
  <li>Game analyses and materials: Retained for 30 days after coaching completion</li>
  <li>Custom training plans: Retained for 60 days after delivery</li>
  <li>Coaching session notes: Retained for 90 days after session completion</li>
</ul>

<h5>2.3. Email and Unsubscribe Policy</h5>
<p>Company uses Personal Information to provide promotional offers by email to individuals. Company may maintain separate email lists for different purposes. If email recipients wish to end their email subscription from a particular list, they need to follow the instructions at the end of each email message to unsubscribe from the particular list. To unsubscribe from all Company's email lists, a person must send an email to ${COMPANY.email}</p>

<h5>2.4. Profiles of Individuals</h5>
<p>Company may use Personal Information to make a profile of an individual. A profile can be created by combining survey information and information obtained from public databases.</p>

<h5>2.5. Storage of Personal Information</h5>
...
<h4>3.0. Other Use of Personal Information</h4>

<h5>3.1. Service Providers</h5>
<p>Company may use third parties to help operate our Website and deliver products and services, and may share your Personal Information with our affiliates, service providers and other third parties that provide products or services for or through this Website or for our business (such as Website or database hosting companies, chess analysis tools, email service providers, analytics companies, distribution companies, fulfillment companies, and other similar service providers that use such information on our behalf).</p>

<h5>3.2. Complying with Legal Process</h5>
<p>Company will use or disclose your Personal Information in response to subpoenas, court orders, warrants, or legal process, or to otherwise establish or exercise our legal rights or defend against legal claims or in the event you violate or breach an agreement with Company.</p>

<h4>4.0. Privacy Practices of Third Parties</h4>

<h5>4.1. Advertiser cookies and web beacons</h5>
...
<h4>5.0. Foreign use of the Website</h4>
<p>To the extent that you are accessing the Website while domiciled outside of the United States of America, you acknowledge that the Personal Information you are providing Company is collected and stored in the United States of America and therefore consent to the transfer of information to and storage of the information outside of your domiciled country and in the United States of America.</p>
