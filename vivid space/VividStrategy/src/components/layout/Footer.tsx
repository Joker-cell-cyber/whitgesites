        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Email: <a href={`mailto:${COMPANY.email}`} className="hover:text-teal-600 dark:hover:text-teal-400">{COMPANY.email}</a>
            </p>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Phone: <a href={`tel:${COMPANY.phone}`} className="hover:text-teal-600 dark:hover:text-teal-400">{COMPANY.phone}</a>
            </p>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link 
                    href="/about"
                    className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 text-sm"
                  >
                    About Us
                  </Link>
                </li>
              ...
              <ul className="space-y-2">
                <li>
                  <button 
                    ...
                    className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 text-sm cursor-pointer"
                  >
                    Terms & Conditions
                  </button>
                </li>
