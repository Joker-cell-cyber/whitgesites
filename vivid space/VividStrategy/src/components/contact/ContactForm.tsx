          ...
          <>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`w-full ${
                  isSubmitting ? 'bg-teal-400 cursor-not-allowed' : 'bg-gradient-to-r from-teal-500 to-emerald-500 hover:opacity-90'
                } text-white py-3 px-6 rounded-lg text-base font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500`}
              >
                {isSubmitting ? (
