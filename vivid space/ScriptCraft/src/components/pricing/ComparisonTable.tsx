            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="py-6 px-4 text-center">
                  <a 
                    href="#pricing-tabs" 
                    className="inline-block px-4 py-2 bg-cs-blue-600 hover:bg-cs-blue-700 transition-colors text-white rounded-lg text-sm font-medium"
                  >
                    Select Basic
                  </a>
                </td>
                <td className="py-6 px-4 text-center bg-gradient-to-b from-vid-red-900/10 to-transparent">
                  <a 
                    href="#pricing-tabs" 
                    className="inline-block px-4 py-2 bg-white border border-gray-200 text-cs-navy-900 rounded-lg text-sm font-medium button-glow"
                  >
                    Select Standard
                  </a>
                </td>
