      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <button
            ...
            className={`w-full px-6 py-3 text-cs-navy-900 font-medium rounded-lg shadow-sm ${
              isSubmitting ? "bg-gray-300" : "bg-white border border-gray-200 hover:bg-gray-50 button-glow"
            } focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 transition-colors duration-200`}
          >
