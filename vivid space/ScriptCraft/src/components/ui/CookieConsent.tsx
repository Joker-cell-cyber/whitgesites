...
const CookieConsent: React.FC = () => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed bottom-0 left-0 right-0 z-50 bg-vf-slate-900 border-t border-vf-slate-800 shadow-lg"
          ...
          {!isSettingsOpen ? (
            <div className="container mx-auto px-4 py-4 md:py-5 flex flex-col md:flex-row items-center md:items-start md:justify-between">
              <div className="mb-4 md:mb-0 max-w-3xl">
                ...
                <p className="text-vf-slate-300 text-sm">
                  ...
                  <Link href="/legal/cookies" className="text-vf-amber-400 hover:text-vf-amber-300 underline">
                    Cookie Policy
                  </Link>{" "}
                  to learn more.
                </p>
              ...
              <div className="flex flex-wrap gap-2 mt-2 md:mt-0">
                <button
                  ...
                  className="px-4 py-2 bg-cs-navy-600 hover:bg-cs-navy-700 text-white rounded-lg text-sm transition-colors"
                >
                  Reject All
                </button>
                <button
                ...
                <button
                  ...
                  className="px-4 py-2 bg-cs-blue-600 hover:bg-cs-blue-700 text-white rounded-lg text-sm font-medium transition-colors"
                >
                  Accept All
                </button>
              </div>
            ...
            <div className="container mx-auto px-4 py-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="text-vf-slate-300 hover:text-white transition-colors"
                >
                  <svg
              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-start justify-between p-4 bg-vf-slate-800/50 rounded-lg">
                  <div>
                    <div className="flex items-center">
                      <h4 className="text-white font-medium">Strictly Necessary</h4>
                      <span className="ml-2 px-2 py-0.5 bg-vf-slate-700 text-white text-xs rounded">Required</span>
                    </div>
                    <p className="text-vf-slate-300 text-sm mt-1">
                  ...
                  <div className="flex items-center h-5">
                    <input
                      ...
                      disabled
                      className="w-4 h-4 accent-vf-amber-600 bg-vf-slate-700 border-vf-slate-600 rounded focus:ring-vf-amber-600"
                    />
                  </div>
                </div>
