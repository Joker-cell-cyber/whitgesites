...
export default function ContactFAQ() {
  const faqs = [
    ...
    {
      question: "Do you work on one-off projects?",
      answer: "Yes, we specialize in one-time projects rather than subscriptions or recurring services. Each project is handled individually according to your specific requirements."
    },
    {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-vid-blue-900/5 to-transparent"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <a
            href="mailto:contact@sunnyfog.com"
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-vid-blue-600 to-vid-white-100 text-gray-800 rounded-lg font-medium button-glow"
          >
