...
<p>When you submit video footage and materials to ${COMPANY.serviceName} for translation services, we collect and process this content to provide our services. This includes video files, audio files, text documents, and any other materials you provide for the purpose of translation.</p>

<h5>1.3. Other Methods of Collecting Personal Information</h5>
<p>Other occasions when Company obtains information from you include: (1) when you place an order for translation services; (2) when you request assistance through Company's customer service department; and (3) when you voluntarily subscribe to a Company service or newsletter.</p>
...
<p>Company may, in certain instances, collect credit card numbers and related information when an individual places an order for translation services on Company's Website. When the credit card information is submitted to Company, such information is encrypted and is protected with SSL encryption software. Company will use the credit card information for purposes of processing and completing the transaction you requested on the Website, and the credit card information will be disclosed to third parties as necessary to complete the requested purchase transaction.</p>

<h4>2.0. Use of Personal Information</h4>

<h5>2.1. Translation Services</h5>
<p>Company uses the content and materials you provide to deliver the translation services you requested. This content is retained according to our data retention policies outlined below.</p>

<h5>2.2. Data Retention for Content</h5>
<p>For your content and project files:</p>
<ul>
  <li>Original documents and materials: Retained for 30 days after project completion</li>
  <li>Translated content: Retained for 60 days after delivery</li>
