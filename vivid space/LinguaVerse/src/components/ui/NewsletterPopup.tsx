      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-[#1e293b] to-[#111827] border border-indigo-800/30 rounded-xl shadow-2xl max-w-md w-full overflow-hidden relative"
            onClick={e => e.stopPropagation()}
          >
            {/* Close button */}
            <button 
              onClick={handleClose}
              className="absolute top-2 right-2 text-white bg-red-600 hover:bg-red-700 rounded-md px-3 py-1 flex items-center justify-center shadow-md transition-colors z-10 font-bold text-sm"
