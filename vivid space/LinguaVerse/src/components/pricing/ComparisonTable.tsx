...
export default function ComparisonTable() {
  ...
  const prices = {
    short: { basic: "$9.90", standard: "$19.90", premium: "$29.90", enhanced: "$39.90", ultra: "$49.90" },
    long: { basic: "$59.90", standard: "$69.90", enhanced: "$79.90", premium: "$99.90", expert: "$109.90", ultra: "$129.90" },
    advertising: { basic: "$29.90", standard: "$49.90", enhanced: "$59.90", professional: "$89.90", premium: "$119.90" }
  };
  ...
  return (
    <section className="py-24 relative" id="comparison">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-96 h-96 bg-blue-600/5 rounded-full transform translate-x-1/4 -translate-y-1/4 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-indigo-500/5 rounded-full transform -translate-x-1/4 translate-y-1/4 blur-3xl"></div>
      </div>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Package <span className="text-gradient-blue">Comparison</span> Table
            </h2>
          ...
          <table className="w-full min-w-[768px]">
                ...
                {selectedCategory === 'short' && (
                  <>
                    <th className="py-4 px-4 text-center">
                      ...
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].basic}</div>
                    </th>
                    <th className="py-4 px-4 text-center bg-gradient-to-b from-blue-900/20 to-transparent relative">
                      ...
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].standard}</div>
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-blue-600 to-indigo-500 text-white text-xs uppercase font-bold py-1 px-2 rounded">
                        Popular
                      </div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Premium</div>
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].premium}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Enhanced</div>
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].enhanced}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Ultra</div>
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].ultra}</div>
                    </th>
                  </>
                )}
                ...
                {selectedCategory === 'advertising' && (
                  <>
                    ...
                    <th className="py-4 px-4 text-center">
                      ...
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].professional}</div>
                    </th>
                    <th className="py-4 px-4 text-center">
                      <div className="text-white font-bold">Premium</div>
                      <div className="text-blue-400 text-xl font-bold">{prices[selectedCategory].premium}</div>
            ...
            <tbody>
              {activeFeatures.map((feature, index) => (
                <tr key={index} className={`border-b border-gray-800 ${index % 2 === 1 ? 'bg-gray-800/10' : ''}`}>
                  ...
                  <td className="py-3 px-4 text-center text-gray-300">
                    {feature.basic === "✓" ? (
                      <svg className="h-5 w-5 text-blue-500 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <td className="py-3 px-4 text-center text-gray-300 bg-gradient-to-b from-blue-900/10 to-transparent">
                    {feature.standard === "✓" ? (
                      <svg className="h-5 w-5 text-blue-500 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                      </svg>
              ...
              <tr>
                ...
                <td className="py-6 px-4 text-center bg-gradient-to-b from-blue-900/10 to-transparent">
                  <a 
                    href="#pricing-tabs" 
                    className="inline-block px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-500 text-white rounded-lg text-sm font-medium button-glow"
                  >
                    Select Standard
                  </a>
                </td>
