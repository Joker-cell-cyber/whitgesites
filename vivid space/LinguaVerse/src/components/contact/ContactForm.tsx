...
export default function ContactForm() {
  ...
  return (
    <motion.div
      ...
      className="bg-[#1e293b] border border-indigo-800/30 rounded-lg shadow-xl p-8"
    >
      <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-500 mb-6">Send Us a Message</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          >
            ...
            <option value="subtitling">Video Subtitling</option>
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-2 bg-gray-900 border border-indigo-700 text-white rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Tell us about your translation needs or questions"
          />
        </div>
        
        <div className="text-sm text-gray-400 mb-4">
          Your message will be sent to {COMPANY.email}
        </div>
        ...
        <div>
          <button
            ...
            className={`w-full px-6 py-3 text-white font-medium rounded-md shadow-sm ${
              isSubmitting ? "bg-blue-800" : "bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 button-glow"
