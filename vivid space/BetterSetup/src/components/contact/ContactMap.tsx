  ...
  return (
    <section className="py-16 relative overflow-hidden">
      ...
      >
        ...
        <div 
          className="absolute left-4 bottom-4 bg-gray-900 p-4 rounded-lg shadow-lg border border-gray-800 max-w-xs"
        >
          <h3 className="font-bold text-white">bettersetup Headquarters</h3>
