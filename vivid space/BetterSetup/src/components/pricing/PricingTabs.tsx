...
export default function PricingTabs() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-900 to-black text-white relative overflow-hidden" id="pricing-tabs">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
            Choose Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500">Perfect</span> Notion Setup
          </h2>
        ...
        {/* Category Tabs */}
        <div className="max-w-md mx-auto mb-12 grid grid-cols-3 gap-4 bg-gray-800/50 p-2 rounded-xl border border-gray-700">
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {activePricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl overflow-hidden border border-gray-800 shadow-xl shadow-indigo-500/5 bg-gradient-to-br from-gray-800/70 to-black/70 backdrop-blur-sm ${
                plan.popular
        ...
        <div className="mt-16 text-center">
          <p className="text-gray-300 mb-6">Need help choosing the right plan? Our team can provide personalized recommendations.</p>
          <a 
            href="/contact" 
