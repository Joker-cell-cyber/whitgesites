...
export const metadata: Metadata = {
  ...
  description: `Terms and conditions for ${COMPANY.serviceName} gaming services. Read our mission protocols before engaging our elite operators for your gaming objectives.`,
};
