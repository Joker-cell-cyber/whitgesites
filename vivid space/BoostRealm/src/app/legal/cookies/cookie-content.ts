...
<h3>Introduction</h3>
<p>This Cookie Policy explains how ${COMPANY.name} ("we", "us", or "our"), operating as ${COMPANY.serviceName} at ${COMPANY.website}, uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
...
<h3>The specific types of cookies we use</h3>
...
<p>If you have any questions about our use of cookies or other technologies, please email us at ${COMPANY.email} or by telephone at ${COMPANY.phone}.</p>
`; 