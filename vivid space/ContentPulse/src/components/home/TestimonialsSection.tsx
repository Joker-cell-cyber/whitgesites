        ...
        <div className="relative max-w-4xl mx-auto">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center">
                  <div>
                    ...
                    <p className="text-black">{testimonials[activeIndex].position}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-center mt-8 gap-3">
            <button 
              ...
              className="w-12 h-12 rounded-full bg-white border border-gray-200 flex items-center justify-center text-black hover:bg-turquoise-50 hover:border-turquoise-200 transition-colors"
