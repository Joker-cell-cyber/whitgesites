        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-block">
              <span className="text-2xl font-bold bg-gradient-to-r from-indigo-300 to-indigo-500 bg-clip-text text-transparent">
                {COMPANY.serviceName}
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href={`mailto:${COMPANY.email}`} className="hover:text-indigo-300 transition-colors">
                  {COMPANY.email}
                </a>
              </li>
              <li>
                <a href={`tel:${COMPANY.phone}`} className="hover:text-indigo-300 transition-colors">
                  {COMPANY.phone}
                </a>
              </li>
              <li className="pt-2">
