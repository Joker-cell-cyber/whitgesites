...
<h3>${COMPANY.serviceName} Lead Generation Packages Offered:</h3>

<h4>B2B Leads</h4>
<ul>
  <li>Starter B2B: $9.99 USD - 25 Leads</li>
  <li>Pro B2B: $19.50 USD - 30 Leads</li>
  <li>Business B2B: $29.90 USD - 40 Leads</li>
  <li>Enterprise B2B: $39.99 USD - 50 Leads</li>
</ul>

<h4>B2C Leads</h4>
<ul>
  <li>Basic Consumer: $49.90 USD - 75 Leads</li>
  <li>Standard Consumer: $59.50 USD - 100 Leads</li>
  <li>Premium Consumer: $69.99 USD - 125 Leads</li>
  <li>Elite Consumer: $79.90 USD - 150 Leads</li>
</ul>

<h4>Industry-Specific Leads</h4>
<ul>
  <li>Healthcare Focus: $89.50 USD - 40 Leads</li>
  <li>Financial Services: $99.99 USD - 35 Leads</li>
  <li>Technology Sector: $109.90 USD - 45 Leads</li>
  <li>Manufacturing Focus: $119.50 USD - 40 Leads</li>
</ul>
...
<p><strong>Payment Structure:</strong> All purchases on ${COMPANY.serviceName} are processed as <strong>one-time payments</strong>. We do not offer recurring subscriptions for any of our lead generation packages.</p>
...
<p><strong>Confirmation:</strong> Upon successful payment, you will receive an email confirmation with details of your purchase and instructions for accessing your lead data.</p>

<p>You will receive a confirmation email with details about accessing your services and next steps within 24 hours of placing your order.</p>
