                    ...
                    {currentStep === 3 && (
                      <div className="p-8">
                        ...
                        <div className="flex justify-between">
                          ...
                          <button
                            type="submit"
                            className="inline-block bg-gradient-to-r from-purple-600 to-pink-500 text-white font-medium py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
                          >
                            Complete Order
                          </button>
                        </div>
