    ...
    >
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link 
            href="/contact" 
            className="bg-gradient-to-r from-purple-600 to-pink-500 text-white font-medium py-2 px-4 rounded-full shadow-lg hover:shadow-xl transition transform hover:-translate-y-0.5"
          >
            Start a project
          </Link>
        </nav>
      ...
      >
        <div className="container mx-auto px-4 py-3 flex flex-col space-y-3">
          ...
          <Link 
            href="/contact" 
            onClick={() => setIsMobileMenuOpen(false)}
            className="block py-2 bg-gradient-to-r from-purple-600 to-pink-500 text-white font-medium px-4 rounded-lg shadow-md"
          >
            Start a project
          </Link>
        </div>
