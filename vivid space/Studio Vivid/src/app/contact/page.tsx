          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
                ...
                {submitSuccess && (
                  <div className="mb-6 p-4 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 rounded-lg">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className={`w-full py-3 px-6 bg-gradient-to-r from-purple-600 to-pink-500 text-white font-bold rounded-lg shadow-lg hover:shadow-xl transition transform hover:-translate-y-0.5 ${
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${COMPANY.email}`} className="text-purple-600 dark:text-purple-400 hover:underline">
                        {COMPANY.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href={`tel:${COMPANY.phone}`} className="text-purple-600 dark:text-purple-400 hover:underline">
                        {COMPANY.phone}
                      </a>
