    ...
    <div className="min-h-screen pt-24 pb-16">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link 
            href="/contact"
            className="inline-block bg-gradient-to-r from-purple-600 to-pink-500 text-white font-medium py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1"
          >
            Contact us
          </Link>
        </div>
