  ...
  return (
    <div className="bg-[#0a0a0a] py-16 min-h-screen">
      <div className="container mx-auto px-4 max-w-6xl">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">Checkout</h1>
            ...
            {packageInfo.name ? (
              <div className="space-y-4">
                <div className="flex justify-between border-b border-gray-800 pb-4">
                  ...
                  <span className="font-medium text-white">{packageInfo.name}</span>
                </div>
                
                <div className="flex justify-between">
                  <span className="text-white">Price</span>
                  <span className="font-medium text-white">${packageInfo.price.toFixed(2)}</span>
                </div>
                
                <div className="border-t border-gray-800 pt-4 mt-4">
                  <div className="flex justify-between font-bold">
                    <span className="text-white">Total</span>
                    <span className="text-white">${packageInfo.price.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            ) : (
