...
<p>Address: ${COMPANY.address}, United States (Hereinafter referred to as "Company").</p>
...
<h5>1.2. Video Content Information</h5>
<p>When you submit video footage and materials to ${COMPANY.serviceName} for editing services, we collect and process this content to provide our services. This includes raw footage, images, audio files, and any other materials you provide for the purpose of video editing.</p>

<h5>1.3. Other Methods of Collecting Personal Information</h5>
<p>Other occasions when Company obtains information from you include: (1) when you place an order for video editing services; (2) when you request assistance through Company's customer service department; and (3) when you voluntarily subscribe to a Company service or newsletter.</p>
...
<p>Company may, in certain instances, collect credit card numbers and related information when an individual places an order for video editing services on Company's Website. When the credit card information is submitted to Company, such information is encrypted and is protected with SSL encryption software. Company will use the credit card information for purposes of processing and completing the transaction you requested on the Website, and the credit card information will be disclosed to third parties as necessary to complete the requested purchase transaction.</p>

<h4>2.0. Use of Personal Information</h4>

<h5>2.1. Video Editing Services</h5>
<p>Company uses the footage and materials you provide to deliver the video editing services you requested. This content is retained according to our data retention policies outlined below.</p>

<h5>2.2. Data Retention for Video Content</h5>
<p>For your video content and project files:</p>
<ul>
  <li>Raw footage and materials: Retained for 30 days after project completion</li>
  <li>Edited videos: Retained for 60 days after delivery</li>
...
<p>Company may use third parties to help operate our Website and deliver products and services, and may share your Personal Information with our affiliates, service providers and other third parties that provide products or services for or through this Website or for our business (such as Website or database hosting companies, video storage providers, email service providers, analytics companies, distribution companies, fulfillment companies, and other similar service providers that use such information on our behalf).</p>
