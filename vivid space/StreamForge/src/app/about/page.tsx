      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl mb-6">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#9D1D20] to-[#FF5757]">StreamForge</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
          <div>
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#9D1D20] to-[#FF5757] rounded-lg blur-lg opacity-25"></div>
            ...
            <div className="mt-12 relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#FF5757] to-[#E31B23] rounded-lg blur-lg opacity-25"></div>
              <div className="relative bg-[#0b0b1e]/80 backdrop-blur p-8 rounded-lg shadow-xl">
                <h2 className="text-2xl font-bold mb-6 text-white">Our Values</h2>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <div className="bg-[#9D1D20]/30 p-2 rounded-lg mr-4">
                      <svg className="h-5 w-5 text-[#FF5757]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#E31B23] to-[#9D1D20] rounded-lg blur-lg opacity-25"></div>
              <div className="relative bg-[#0b0b1e]/80 backdrop-blur p-8 rounded-lg shadow-xl">
            ...
            <div className="mt-12 relative">
              ...
              <div className="relative bg-[#0b0b1e]/80 backdrop-blur p-8 rounded-lg shadow-xl">
                ...
                <ol className="space-y-4 text-gray-300">
                  <li className="flex items-start">
                    <span className="bg-[#9D1D20] w-8 h-8 rounded-full flex items-center justify-center text-white font-bold mr-4">1</span>
                    <p><strong>Understand:</strong> We start by deeply understanding the streaming landscape and creator needs.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-[#FF5757] w-8 h-8 rounded-full flex items-center justify-center text-[#121212] font-bold mr-4">2</span>
                    <p><strong>Design:</strong> Our professional designers create visually stunning assets that perfectly blend with your brand.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-[#E31B23] w-8 h-8 rounded-full flex items-center justify-center text-white font-bold mr-4">3</span>
                    <p><strong>Deliver:</strong> We provide ready-to-use graphics packages with clear implementation instructions.</p>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-[#9D1D20] w-8 h-8 rounded-full flex items-center justify-center text-white font-bold mr-4">4</span>
        ...
        <div className="mt-20 text-center">
          ...
          <a 
            href="/pricing" 
            className="inline-block px-8 py-3 bg-gradient-to-r from-[#9D1D20] to-[#E31B23] text-white rounded-lg font-medium shadow-lg hover:opacity-90 transition-all"
          >
