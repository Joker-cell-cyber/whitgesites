...
const CookieConsent: React.FC = () => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="fixed bottom-0 left-0 right-0 z-50 bg-[#0f0f1a] border-t border-[--neon-red]/20 shadow-lg"
            ...
            <div className="container mx-auto px-4 py-4 md:py-5 flex flex-col md:flex-row items-center md:items-start md:justify-between">
              <div className="mb-4 md:mb-0 max-w-3xl">
                ...
                <p className="text-gray-400 text-sm">
                  ...
                  <Link href="/legal/cookies" className="text-[--neon-red] hover:text-[--neon-red]/80 underline">
                    Cookie Policy
                  </Link>{" "}
                  to learn more.
                </p>
              ...
              <div className="flex flex-wrap gap-2 mt-2 md:mt-0">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-r from-[--neon-darkred] to-[--neon-red] hover:opacity-90 text-white rounded-lg text-sm font-medium transition-colors"
                >
                  Accept All
                </button>
              </div>
                ...
                <div className="flex items-start justify-between p-4 bg-gray-800/50 rounded-lg">
                  ...
                  <div className="flex items-center h-5">
                    <input
                      ...
                      disabled
                      className="w-4 h-4 accent-[--neon-red] bg-gray-700 border-gray-600 rounded focus:ring-[--neon-red]"
                    />
                  </div>
                </div>
