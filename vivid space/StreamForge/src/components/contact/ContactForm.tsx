...
export default function ContactForm() {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#9D1D20] to-[#FF5757] mb-6">Send Us a Message</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 bg-gray-900 border border-gray-700 text-white rounded-md focus:ring-2 focus:ring-[#E31B23] focus:border-[#E31B23]"
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-4 py-2 bg-gray-900 border border-gray-700 text-white rounded-md focus:ring-2 focus:ring-[#FF5757] focus:border-[#FF5757]"
          >
        ...
        <div>
          <button
            ...
            className={`w-full px-6 py-3 text-white font-medium rounded-md shadow-sm ${
              isSubmitting ? "bg-[#9D1D20]/50" : "bg-gradient-to-r from-[#9D1D20] to-[#E31B23] hover:opacity-90 button-glow"
            } focus:outline-none focus:ring-2 focus:ring-[#FF5757] focus:ring-offset-2 transition-colors duration-200`}
          >
            {isSubmitting ? (
          ...
          <p className="mt-2 text-xs text-gray-400 text-center">
            By submitting this form, you agree to our <a href="/legal/privacy" className="text-[#FF5757] underline">Privacy Policy</a>.
          </p>
        </div>
      </form>
    </motion.div>
