    ...
    <section className="py-16 relative overflow-hidden">
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#1a1a1a] overflow-hidden">
          <div className="absolute inset-0 opacity-40 bg-[url('https://api.mapbox.com/styles/v1/mapbox/dark-v10/static/-83.617,41.639,13,0/1200x400?access_token=pk.placeholder')] bg-no-repeat bg-cover"></div>
        ...
        <div className="absolute left-4 bottom-4 bg-gray-900 p-4 rounded-lg shadow-lg border border-gray-800 max-w-xs">
          <h3 className="font-bold text-white">Nutrition Headquarters</h3>
          <p className="text-gray-300 text-sm mt-1">
            {COMPANY.address.split(',')[0]}<br />
            {COMPANY.address.split(',')[1]}<br />
            United States
          </p>
          <a 
