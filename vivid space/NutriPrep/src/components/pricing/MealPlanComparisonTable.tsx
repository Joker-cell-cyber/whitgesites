                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                    selectedCategory === category
                      ? 'bg-gradient-to-r from-turquoise-600 to-purple-500 text-white'
          ...
          <table className="w-full min-w-[768px]">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="py-4 px-4 text-center bg-turquoise-50 relative">
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-turquoise-600 to-purple-500"></div>
                  <div className="text-gray-800 font-bold">Standard</div>
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-turquoise-600 to-purple-500 text-white text-xs uppercase font-bold py-1 px-2 rounded">
                    Popular
                  </div>
                </th>
                <th className="py-4 px-4 text-center">
              ...
              {activeFeatures.map((feature, index) => (
                <tr key={index} className={`${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-gray-100 transition-colors`}>
                  ...
                  <td className="py-3 px-4 border-b border-gray-200 text-center">
                    {feature.basic === "✓" ? (
                      <svg className="h-5 w-5 text-turquoise-500 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <td className="py-3 px-4 border-b border-gray-200 text-center bg-turquoise-50">
                    {feature.standard === "✓" ? (
                      <svg className="h-5 w-5 text-turquoise-500 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                      </svg>
              ...
              <tr className="bg-turquoise-50">
                <td colSpan={6} className="py-4 px-4 text-center">
                  <div className="flex items-center justify-center gap-4">
                    <a href="#pricing-tabs" className="px-6 py-2 bg-gradient-to-r from-turquoise-600 to-purple-500 hover:from-turquoise-700 hover:to-purple-600 text-white rounded-lg transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-turquoise-500 focus:ring-offset-2">
                      View Detailed Plans
                    </a>
