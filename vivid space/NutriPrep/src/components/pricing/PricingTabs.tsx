      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {activePricingPlans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="bg-gradient-to-r from-turquoise-600 to-purple-500 text-white text-center text-xs py-1 font-medium">
                  MOST POPULAR
                </div>
              )}
              ...
              <div className="p-6 flex-grow flex flex-col">
                ...
                <ul className="space-y-3 my-6 flex-grow">
                  {plan.deliverables.map((feature, i) => (
                    <li key={i} className="flex items-start">
                      <svg className="h-5 w-5 text-turquoise-500 mt-0.5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                ...
                <Link
                  ...
                  className={`w-full px-4 py-3 text-center text-white font-medium rounded-md ${
                    plan.popular
                      ? 'bg-gradient-to-r from-turquoise-600 to-purple-500 hover:from-turquoise-700 hover:to-purple-600 shadow-md'
