  ...
  return (
    <section className="relative pt-32 pb-16 overflow-hidden bg-gray-50">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-20 right-[10%] w-72 h-72 bg-turquoise-600/20 rounded-full filter blur-3xl animate-pulse-glow"></div>
        <div className="absolute bottom-20 left-[5%] w-80 h-80 bg-purple-500/15 rounded-full filter blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 items-center">
            <a 
              href="#pricing-tabs" 
              className="px-6 py-3 bg-gradient-to-r from-turquoise-600 to-purple-500 text-white rounded-lg font-medium button-glow"
            >
              View Meal Plans
            </a>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-turquoise-500 to-purple-500 flex items-center justify-center text-white mb-4 mx-auto">
