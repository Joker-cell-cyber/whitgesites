    ...
    >
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:block">
            <Link 
              href="/pricing" 
              className="px-5 py-2.5 bg-gradient-to-r from-turquoise-600 to-purple-500 text-white rounded-lg font-medium button-glow"
            >
              Get Started
            </Link>
          </div>
      ...
      {mobileMenuOpen && (
        <motion.div 
          ...
          className="md:hidden bg-[#1a1a1a] border-t border-turquoise-900/20"
        >
          <div className="px-4 py-5 space-y-4">
            ...
            <div className="pt-2">
              <Link 
                href="/pricing" 
                className="block w-full px-5 py-3 bg-gradient-to-r from-turquoise-600 to-purple-500 text-white rounded-lg font-medium text-center"
...
function NavLink({ href, children, scrolled }: { href: string, children: React.ReactNode, scrolled: boolean }) {
  ...
  return (
    ...
    >
      {children}
      <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-turquoise-500 to-purple-500 transition-all duration-300 group-hover:w-full"></span>
    </Link>
  );
}
