...
export const metadata: Metadata = {
  title: "Contact Us | Meal Prep Services",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight text-gray-800 sm:text-5xl md:text-6xl mb-6">
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-turquoise-500 to-purple-500">For Any Questions</span>
          </h1>
