        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/" className="flex items-center">
            ...
            <span className="text-xl md:text-2xl font-bold font-playfair text-white">
              Ace<span className="text-chip-gold-500">Strategy</span>
            </span>
          </Link>
          ...
          <div className="hidden md:block">
            <Link 
              href="/pricing" 
              className="px-5 py-2.5 bg-gradient-to-r from-poker-royal-700 to-poker-royal-800 text-white rounded-lg font-medium button-glow relative overflow-hidden"
            >
        ...
        >
          <div className="px-4 py-5 space-y-3">
            ...
            <div className="pt-3">
              <Link 
                href="/pricing" 
                className="block w-full px-5 py-3 bg-gradient-to-r from-poker-royal-700 to-poker-royal-800 text-white rounded-lg font-medium text-center font-special-elite uppercase tracking-wider"
