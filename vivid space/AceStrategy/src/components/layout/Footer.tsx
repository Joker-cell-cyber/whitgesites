          ...
          <div className="col-span-1 md:col-span-4">
            ...
            <div className="mt-6 bg-black/30 rounded-lg p-4 border border-felt-800">
              ...
              <div className="flex">
                ...
                />
                <button className="px-4 py-2 bg-gradient-to-r from-poker-royal-700 to-poker-royal-800 text-white rounded-r-md font-special-elite uppercase tracking-wider hover:from-poker-royal-600 hover:to-poker-royal-700 transition-colors">
                  ALL IN
                </button>
              </div>
            </div>
