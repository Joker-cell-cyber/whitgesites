    ...
    <div className="p-8">
      ...
      {isLoading ? (
        ...
        <div className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-purple-500/20">
          <p className="text-gray-400 text-center">Vous n'avez aucun abonnement actif.</p>
        </div>
      ) : (
        <div className="space-y-6">
          {subscriptions.map(subscription => (
            <div key={subscription.id} className="bg-black/40 backdrop-blur-xl rounded-xl p-6 border border-purple-500/20">
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-400">Prochaine facturation</h3>
                  <p className="text-white">{formatDate(subscription.nextBillingDate)}</p>
                </div>
              </div>
              
              <div className="mt-4">
                <h3 className="text-sm font-medium text-gray-400 mb-2">Fonctionnalités incluses</h3>
              ...
              <div className="mt-4">
                <h3 className="text-sm font-medium text-gray-400">Allocation de tokens</h3>
                <p className="text-white">{subscription.tokenAllowance} tokens / {subscription.billingCycle === 'monthly' ? 'mois' : 'an'}</p>
              </div>
