...
import { getTokenProductId, TOKEN_PRICE as enterpriseTokenPrice } from './page-tokens';
  ...
  const handlePurchaseTokens = async () => {
    try {
      ...
      if (productId) {
        ...
        window.location.href = `/pre-checkout?plan=pro&period=one-time&price=${calculateTokenPrice(selectedTokens)}&tokens=${selectedTokens}&tokenPrice=${enterpriseTokenPrice}&productId=${productId}&source=tokens`;
      } else {
