    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-pink-100 to-white">Déconnexion en cours...</h1>
          <p className="text-gray-400">Vous allez être redirigé vers la page d'accueil</p>
