  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white/80 backdrop-blur-xl rounded-xl p-6 border border-pink-200/40 shadow-sm">
            <div className="h-4 w-24 bg-gray-200 rounded animate-pulse mb-4"></div>
            <div className="h-8 w-16 bg-gray-200 rounded animate-pulse"></div>
            <div className="mt-4 w-full h-2 bg-gray-200 rounded-full"></div>
            <div className="h-3 w-32 bg-gray-100 rounded animate-pulse mt-4"></div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {/* Actions rapides */}
        <div className="md:col-span-2 bg-white/80 backdrop-blur-xl rounded-xl p-6 border border-pink-200/40 shadow-sm">
        ...
        {/* Acheter des tokens */}
        <div className="bg-white/80 backdrop-blur-xl rounded-xl p-6 border border-pink-200/40 shadow-sm">
      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-xl p-6 border border-pink-200/40 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-r from-pink-100/40 to-red-100/40 rounded-lg p-4 border border-pink-200/40">
