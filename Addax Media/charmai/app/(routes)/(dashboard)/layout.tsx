          ...
          <div className="flex items-center justify-between px-4 h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-pink-50 border border-pink-100">
                ...
                <Sparkles className="h-3 w-3 text-pink-500 opacity-80" />
              </div>

              {/* Menu mobile */}
              <button
                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                className="lg:hidden p-2 rounded-lg bg-white border border-pink-100"
                aria-label="Menu"
              >
              ...
              <div className="hidden lg:flex items-center gap-2">
                ...
                <Link
                  href="/subscriptions"
                  className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-gray-600 hover:text-gray-800 hover:bg-pink-50/50 transition-colors"
                >
        ...
        <div className={`fixed inset-0 z-40 bg-white/95 backdrop-blur-xl lg:hidden transform transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          <div className="flex flex-col h-full pt-16">
            <nav className="flex-1 p-4 space-y-2">
              ...
              <Link
                href="/subscriptions"
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-gray-800 hover:bg-pink-50/50 transition-colors"
                onClick={() => setIsMobileMenuOpen(false)}
              >
              ...
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 hover:text-gray-800 hover:bg-pink-50/50 transition-colors w-full"
              >
