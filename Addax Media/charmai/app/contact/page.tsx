...
function ContactContent() {
  ...
  const protectedEmail = obfuscateText("support@charmai.com");
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          from_name: 'Formulaire de contact CharmAI'
        })
      });
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p 
                        ...
                        onCopy={(e) => {
                          e.preventDefault();
                          navigator.clipboard.writeText("support@charmai.com");
                        }}
                      >
                        {protectedEmail}
                      </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p 
                        ...
                        onCopy={(e) => {
                          e.preventDefault();
                          navigator.clipboard.writeText("(803) 886-0993");
                        }}
                      >
                        {protectedPhone}
                      </p>
