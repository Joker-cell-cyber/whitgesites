      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="mt-4 w-full h-2 bg-slate-100 rounded-full"></div>
            <div className="h-3 w-32 bg-slate-100 rounded animate-pulse mt-4"></div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="md:col-span-2 bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="h-12 w-full bg-slate-100 rounded animate-pulse"></div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
          ...
          <div className="h-4 w-full bg-slate-100 rounded animate-pulse mb-6"></div>
          <div className="h-12 w-full bg-slate-200 rounded animate-pulse"></div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="h-4 w-full bg-slate-100 rounded animate-pulse mb-4"></div>
