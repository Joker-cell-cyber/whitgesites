      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <motion.div
            ...
            className="relative w-[90%] max-w-2xl max-h-[85vh] overflow-hidden rounded-2xl bg-black border border-purple-500/20 shadow-2xl"
          >
            {/* Header avec effet de flou */}
            <div className="sticky top-0 z-10 bg-black/95 backdrop-blur-xl border-b border-purple-500/20">
              <div className="px-6 py-4 flex items-center justify-between">
                ...
                <button
                  onClick={onClose}
                  className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all duration-200 hover:scale-110"
                >
